...
5. Create Contact Form 7 form with nCaptcha and nCaptcha transaction fields
5. Join the results

== Screenshots ==

1. Create form using nCaptcha and nCaptcha transaction fields screenshot-1.png using price and your near account
3. Add form to page using gutenberg blocks or classic editor screenshot-2.png.
4. Now nCaptcha is provided. screenshot-3.png
